...
import { getRecommendedSmartProperties } from '../../actions'
...
const PropertyDetailSmartRecommendedProperty = React.memo(props => {
  const {
  ...
  useEffect(() => {
    getRecommendedSmartProperties(
      ...
      if (res.success) {
        ...
        setRecommendedProperties(res?.data?.splice(0, 3))
      }
    })
  }, [])
...
export default withRouter(
  withSizes(mapSizesToProps)(PropertyDetailSmartRecommendedProperty)
)
