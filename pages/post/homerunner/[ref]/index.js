...
import HomeRunnerComponent from '../../../../components/Post/Homerunner'

const HomeRunnerPage = props => {
  const { propertyDetail } = props
  if (propertyDetail) {
    return <HomeRunnerComponent propertyDetail={propertyDetail} />
  }
  return <PageNotFound />
}
